...
(function ($) {
    $.fn.tableExport = function (options) {
        ...
        if (defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type === 'txt') {
            ...
            docFile += '<meta http-equiv="content-type" content="blob: null' + MSDocType + '; charset=UTF-8">';
            docFile += '<head>';
            if (MSDocType === 'excel') {
            ...
            saveToFile(docFile, defaults.fileName + '.' + MSDocExt, 'blob: null' + MSDocType, '', 'base64', false);
